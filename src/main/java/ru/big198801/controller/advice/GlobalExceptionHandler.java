package ru.big198801.controller.advice;
...
import ru.big198801.model.dto.ErrorDto;
...
public class GlobalExceptionHandler {
    ...
    public ErrorDto handleHttpServerErrorException(HttpServerErrorException e, HttpServletRequest request) {
        ...
        return new ErrorDto(
                ...
                "Error connecting to external service. Try connecting to external service later.",
                request.getRequestURI()
        );
    }
    ...
    public ErrorDto handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        String message = "Invalid parameter type: " + e.getName() +
                ". Expected: " + (e.getRequiredType() != null ? e.getRequiredType().getSimpleName() : "unknown");
        return new ErrorDto(
                OffsetDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
